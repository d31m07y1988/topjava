...
public class UserMealsUtil {
    public static final List<UserMeal> MEAL_LIST = Arrays.asList(
            ...
            new UserMeal(LocalDateTime.of(2016, Month.APRIL, 15, 13,0), "lunch", 1200, 1)
    );
    ...
    public static UserMealWithExceed createWithExceed(UserMeal um, boolean exceeded) {
        return new UserMealWithExceed(um.getId(), um.getDateTime(), um.getDescription(), um.getCalories(), um.getUserId(), exceeded);
    }
}