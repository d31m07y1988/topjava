...
<section>
    <div class="top48 container">
        <div class="panel panel-default top15">
            <div class="panel-heading"><h3><fmt:message key="meals.filter"/></h3></div>
    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading"><h3><fmt:message key="meals.title"/></h3></div>
            <div class="panel-body">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="text" class="form-control" id="calories" name="calories" placeholder="001">
                        </div>
                    </div>
