...
/**
 * Created by Ramil on 06.07.2016.
 */
...
public abstract class CommonUserMealServiceTest {
    private static final Logger LOG = LoggerFactory.getLogger(JPAUserMealServiceTest.class);
    @Rule
